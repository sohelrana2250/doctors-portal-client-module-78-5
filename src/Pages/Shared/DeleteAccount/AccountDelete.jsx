...
const AccountDelete = () => {
  ...
  const handelDeleteAccount = (event) => {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        fetch(`${process.env.REACT_APP_SERVER_API}/api/v1/deleteAccount`, {
          method: "DELETE",
          headers: {
  ...
  return (
    <>
      <div className="w-full px-4 py-2 h-screen rounded md:w-full  lg:w-full bg-[url(https://static.vecteezy.com/system/resources/thumbnails/022/010/648/small/black-background-modern-dark-abstract-texture-vector.jpg)] ">
